...
from aletheia.rag.parsers.dots_ocr.utils.image_utils import smart_resize
from aletheia.rag.parsers.dots_ocr.utils.consts import MIN_PIXELS, MAX_PIXELS
from aletheia.rag.parsers.dots_ocr.utils.output_cleaner import OutputCleaner
