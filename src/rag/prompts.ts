...
export const CUMULATIVE_SUMMARY_PROMPT = `
...
export const BATCH_SUMMARY_INITIAL = `
...
export const BATCH_SUMMARY_INCREMENTAL = `
...
export const MULTI_DOCUMENT_SYSTEM_PROMPT = `
...
export const TABLE_FALLBACK_PROMPT = `
